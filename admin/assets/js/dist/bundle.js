...
var _sidebar = __webpack_require__(/*! ./components/sidebar */ "./assets/js/src/components/sidebar.js");

var _sidebar2 = _interopRequireDefault(_sidebar);

var _page = __webpack_require__(/*! ./components/page */ "./assets/js/src/components/page.js");

var _page2 = _interopRequireDefault(_page);

var _user = __webpack_require__(/*! ./user */ "./assets/js/src/user.js");

var _helper = __webpack_require__(/*! ./helper */ "./assets/js/src/helper.js");
...
var App = function (_React$Component) {
	...
	function App(props) {
		...
		_this.state = {
			auth: _user.User.token,
			settings: false
		};

		_helper.h.on('authStateChanged', function () {
			this.setState({ auth: _user.User.token });
		}.bind(_this));
		...
		(0, _helper.xhr)({
			...
			success: function (res) {
				_helper.h.parseSettings(res.data);
		...
		value: function render() {
			if (this.state.auth && this.state.settings) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_page2.default, { params: this.state.params })
				);
			} else {
...
var Login = function (_React$Component2) {
	...
	function Login(props) {
		...
		_this2.signIn = _this2.signIn.bind(_this2);
	...
	_createClass(Login, [{
		...
		value: function signIn(e) {
			...
			_user.User.auth(this.state.username, this.state.password).then(function () {
				_helper.h.emit('authStateChanged');
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						null,
						_react2.default.createElement('span', { className: 'ico ico-email' }),
						_react2.default.createElement('input', { type: 'text', placeholder: 'Username', onChange: this.updateUsername, onKeyPress: this.signIn })
					),
					_react2.default.createElement(
						'p',
						null,
						_react2.default.createElement('span', { className: 'ico ico-lock' }),
						_react2.default.createElement('input', { type: 'password', placeholder: 'Password', onChange: this.updatePassword, onKeyPress: this.signIn })
					),
					_react2.default.createElement(
						'p',
						null,
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-primary', onClick: this.signIn },
							'Sign in'
						)
					)
				)
...
_reactDom2.default.render(_react2.default.createElement(App, { page: 'all' }), document.querySelector('#root'));

/***/ }),

/***/ "./assets/js/src/components/page.js":
/*!******************************************!*\
  !*** ./assets/js/src/components/page.js ***!
  \******************************************/
/*! no static exports found */
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'span',
						null,
						_helper.config.settings['site name']
					),
					'Control Panel'
				),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'li',
						{ 'data-page': 'home' },
						_react2.default.createElement('span', { className: 'ico ico-home' }),
						'Dashboard'
					),
					_react2.default.createElement(
						'li',
						{ 'data-page': 'settings' },
						_react2.default.createElement('span', { className: 'ico ico-folder-open' }),
						'Pages'
					),
					_react2.default.createElement(
						'li',
						{ 'data-page': 'signout' },
						_react2.default.createElement('span', { className: 'ico ico-menu' }),
						'Menu'
					),
					_react2.default.createElement(
						'li',
						{ 'data-page': 'all' },
						_react2.default.createElement('span', { className: 'ico ico-account-child' }),
						'Users'
					),
					_react2.default.createElement(
						'li',
						{ 'data-page': 'all' },
						_react2.default.createElement('span', { className: 'ico  ico-verified-user' }),
						'Administrators'
					),
					_react2.default.createElement(
						'li',
						{ 'data-page': 'all' },
						_react2.default.createElement('span', { className: 'ico ico-notifications-none' }),
						'Notifications'
					),
					_react2.default.createElement(
						'li',
						{ 'data-page': 'approved' },
						_react2.default.createElement('span', { className: 'ico ico-settings' }),
						'Settings'
					),
					_react2.default.createElement(
						'li',
						{ 'data-page': 'signout' },
						_react2.default.createElement('span', { className: 'ico ico-payment' }),
						'Transactions'
					),
					_react2.default.createElement('li', { 'data-page': '', className: 'divider' }),
					_react2.default.createElement(
						'li',
						{ 'data-page': 'signout' },
						_react2.default.createElement('span', { className: 'ico ico-exit-to-app' }),
						'Sign out'
					)
				)
			);
...
exports.config = exports.xhr = exports.storage = exports.lg = exports.h = undefined;

var _config = __webpack_require__(/*! ./config */ "./assets/js/src/config.js");

var EventEmitter = __webpack_require__(/*! event-emitter */ "./node_modules/event-emitter/index.js"),
    HelperFunctions = function HelperFunctions() {
	this.lg = function (o, level) {
		...
		if (console) {
			switch (level) {
				case 'trace':
					console.log('%c' + o, 'color: #2f68b4');break;
				case 'error':
					console.error(o);break;
				case 'warn':
					console.warn(o);break;
				case 'log':
				case 'info':
				default:
					console.log(o);break;
	...
	this.parseSettings = function (settings) {
		for (var i = 0; i < settings.length; i++) {
			_config.config.settings[settings[i].name] = settings[i].value;
		}
	};
	...
	this.xhr = function (options) {
		...
		$.ajax({
			url: _config.config.api.host + settings.path,
			data: settings.data,
...
var UserClass = function UserClass() {
	this.token = _helper.storage.getItem('swd.token') || null;
			...
			_helper.h.xhr({
				...
				success: function (result) {
					if (result.status) {
						...
						_helper.storage.setItem('swd.token', this.token);
						resolve();
					} else {
						reject(result.error);
					}
	...
	(0, _helper.lg)('auth > token [' + this.token + ']');
},
    User = new UserClass(); /* 
                             * Author Slash Web Design
                             */
